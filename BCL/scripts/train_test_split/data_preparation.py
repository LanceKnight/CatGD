...
def process_dataset(dataset):
	...
	for set_type in ['train', 'test']:
		input_filesname=f'sdfs/train_test/{dataset}_{set_type}_{split}_matched.sdf'
		# input_filesname=f'train_test_sdfs/{dataset}_act_and_inact.sdf'
		...
		os.system(f'bcl.exe descriptor:GenerateDataset \
			...
			-output feat/{dataset}_{set_type}_{split}.RSR.bin\
