...
task_comment = '\" molkgnn; with BCL feat\"' # Change this
...
def run(exp_id, *args):
    exp_name = f'exp{exp_id}_{args[0]}_{args[16]}_seed{args[1]}_warm{args[2]}_epoch{args[3]}_peak{args[4]}_layers{args[6]}_k1{args[7]}_k2{args[8]}_k3{args[9]}_k4{args[10]}_hidden{args[11]}_batch{args[12]}_decay{args[14]}_dropout{args[15]}' # Change this
...
github_repo_dir = f'../experiments/template_JCIM'# Change this
...
if __name__ == '__main__':
    ...
    # dataset_list = ['1798', '435034', '1843', '2258', '463087', '488997','2689', '485290']
    ...
    split_id = ['split2'] # arg16
    data_pair = list(itertools.product(dataset_list, seed_list, warmup_list, epochs_list, peak_lr_list, end_lr_list, num_layer_list, kernel1_list, kernel2_list, kernel3_list, kernel4_list, hidden_dim, batch_size, trials, decay_list, dropout_list, split_id )) 
